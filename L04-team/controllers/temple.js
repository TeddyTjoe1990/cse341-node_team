...
exports.create = (req, res) => {
	/*
    #swagger.description = 'This will create new temple record or document <br/><br>
	 	API Key if needed: <br>Ezl0961tEpx2UxTZ5v2uKFK91qdNAr5npRlMT1zLcE3Mg68Xwaj3N8Dyp1R8IvFenrVwHRllOUxF0Og00l0m9NcaYMtH6Bpgdv7N'
   */
	// Validate request
		...
		temple
			...
			.catch((err) => {
				res.status(500).send({
					message:
						err.message ||
						'Some error occurred while creating the Temple.',
				});
			});
	} else {
...
exports.findAll = (req, res) => {
	/*
    #swagger.description = 'No API Key is needed to view ALL temple records'
   */
	// console.log(req.header('apiKey'));
	// if (req.header('apiKey') === apiKey) {
	Temple.find(
